...
:
	...
	m_event_manager(),
	m_sound_engine(),
	m_world(m_vulkan_api, m_sound_engine, m_event_manager, m_client, player_id),
	m_render_thread(m_settings, m_vulkan_api, m_start_time),
	m_update_thread(m_client, m_settings, m_window, m_world, m_vulkan_api, m_sound_engine, m_event_manager, m_start_time),
